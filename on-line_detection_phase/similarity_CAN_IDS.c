...
float overlap_coefficient(int num_intersection, int WindowSize)
{
	return (float)(num_intersection)/WindowSize;
}

void SimilarityBased_DoSAttackDetect(double SimpsonCoefficient, double k, double div, double ave, int WindowSize, struct timespec ts_start, struct timespec ts_end)
{
	double detect_time;
